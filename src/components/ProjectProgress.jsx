  ...
  return (
    <div className="flex items-center justify-center">
      <div className="bg-white w-full lg:w-80 p-6 rounded-2xl shadow-lg">
        ...
        <div className="flex items-center justify-center">
          <div
            className="relative w-52 h-52 md:w-40 md:h-40 lg:w-52 lg:h-52 rounded-full flex items-center justify-center"
            style={{
        ...
        {/* Legend */}
        <div className="grid grid-cols-1 lg:grid-cols-3 justify-between mt-6 text-sm text-gray-600">
